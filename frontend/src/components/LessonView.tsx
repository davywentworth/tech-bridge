      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        {viewMode === 'sidebyside' ? (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 28 }}>
            <CodeBlock title={`${knownTech} way`} code={lesson.knownWayCode} language={lesson.language} />
            <CodeBlock title={`${targetTech} way`} code={lesson.targetWayCode} language={lesson.language} />
          </div>
        ) : (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 28 }}>
            <CodeBlock title={`The ${knownTech} way (what you know)`} code={lesson.knownWayCode} language={lesson.language} />
            <div style={{ padding: '10px 16px', background: '#eff6ff', borderRadius: 8, fontSize: 13, color: '#1d4ed8' }}>
              ↓ In {targetTech}, this becomes:
            </div>
            <CodeBlock title={`The ${targetTech} way (what you're learning)`} code={lesson.targetWayCode} language={lesson.language} />
          </div>
        )}
        ...
        <section style={{ marginBottom: 20 }}>
          ...
          <div style={{ padding: '12px 16px', background: '#f9fafb', borderRadius: 8, marginBottom: 16, fontSize: 14, lineHeight: 1.6 }}>
